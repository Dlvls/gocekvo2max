package com.example.gocekvo2max.tutorial.balke.slider
...
class BTutorialFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val layoutResId = arguments?.getInt(ARG_LAYOUT_RES_ID, R.layout.tutorial_balke_1)
